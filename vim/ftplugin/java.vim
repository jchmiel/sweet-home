...
iab  Zf for(;;) {<CR>}<Up><Right><Right><Right>
iab  Zw while() {<CR>}<Up><Right><Right><Right><Right><Right>
iab  Zi if () {<CR>}<Up><Right><Right><Right>
iab  Zie if () {<CR>} else {<CR>}<CR><Up><Up><Up><Right><Right><Right><Right>
